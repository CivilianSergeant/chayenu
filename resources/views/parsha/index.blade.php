...
<ul class="nav navbar-nav">
    ...
    <li><a href="{{url('parshas')}}"><span class="glyphicon glyphicon-list"></span> Parsha List</a></li>
    ...
    <div class="col-md-12 jumbotron">
        ...
        <form action="{{url('parsha/create')}}" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                <label class="control-label col-md-3">Parsha Name</label>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="parsha_name"/>
                </div>
            </div>
            <div class="form-group">
